<?php
$XManager['debug'] 			 = false; #slim debug

$XManager['display_errors']  = "0"; # 1: enable / 0 : disable   // PHP display_errors
$XManager['error_reporting'] = 0; # E_ALL: enable / 0 : disable // PHP error_reporting
