				<div class="tab-pane  fade show applist4" id="rounded-pills-icon-A5" role="tabpanel" aria-labelledby="rounded-pills-icon-A5-tab">
				   ...
				   <div class="card-body tab-content" id="rounded-pills-icon-tabContent">
					  ...
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-17" role="tabpanel" aria-labelledby="rounded-pills-icon-17-tab">
						 ...
						 <p>
							{$lang->get('setup')} 
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_17"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
						 <p>
							{$lang->get('ConfigLink')} 
					  ...
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-18" role="tabpanel" aria-labelledby="rounded-pills-icon-18-tab">
						 ...
						 <p>
							{$lang->get('setup')} 
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_18"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
						 <p>
							{$lang->get('ConfigLink')} 
					  ...
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-19" role="tabpanel" aria-labelledby="rounded-pills-icon-19-tab">
						 ...
						 <p>
							{$lang->get('setup')} 
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_19"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
						 <p>
							{$lang->get('ConfigLink')}  
					  ...
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-20" role="tabpanel" aria-labelledby="rounded-pills-icon-20-tab">
						 ...
						 <p>
							{$lang->get('setup')} 
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_20"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
						 <p>
							{$lang->get('ConfigLink')}  
