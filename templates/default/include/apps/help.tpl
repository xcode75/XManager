				<div class="tab-pane  fade show applist6" id="rounded-pills-icon-A7" role="tabpanel" aria-labelledby="rounded-pills-icon-A7-tab">
				   ...
				   <div class="card-body tab-content" id="rounded-pills-icon-tabContent">
					  ...
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-25" role="tabpanel" aria-labelledby="rounded-pills-icon-25-tab">
						 ...
						 <p>
							{$lang->get('setup')}  
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_25"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
					  </div>
					  {/if}
					  {if $app->getStatus(26) == 1}
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-26" role="tabpanel" aria-labelledby="rounded-pills-icon-26-tab">
						 ...
						 <p>
							{$lang->get('setup')} 
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_26"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
					  </div>
					  {/if}
					  {if $app->getStatus(27) == 1}
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-27" role="tabpanel" aria-labelledby="rounded-pills-icon-27-tab">
						 ...
						 <p>
							{$lang->get('setup')}  
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_27"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
					  </div>
					  {/if}
					  {if $app->getStatus(28) == 1}
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-28" role="tabpanel" aria-labelledby="rounded-pills-icon-28-tab">
						 ...
						 <p>
							{$lang->get('setup')} 
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_28"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
					  </div>
					  {/if}
				   </div>
