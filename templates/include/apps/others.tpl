				<div class="tab-pane  fade show applist7" id="rounded-pills-icon-A8" role="tabpanel" aria-labelledby="rounded-pills-icon-A8-tab">
				   ...
				   <div class="card-body tab-content" id="rounded-pills-icon-tabContent">
					  ...
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-29" role="tabpanel" aria-labelledby="rounded-pills-icon-29-tab">
						 <p>
							{$lang->get('setup')} 
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_29"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
					  </div>
					  {/if}
					  {if $app->getStatus(30) == 1}
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-30" role="tabpanel" aria-labelledby="rounded-pills-icon-30-tab">
						 <p>
							{$lang->get('setup')} 
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_30"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
					  </div>
					  {/if}
					  {if $app->getStatus(31) == 1}
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-31" role="tabpanel" aria-labelledby="rounded-pills-icon-31-tab">
						 <p>
							{$lang->get('setup')} 
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_31"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
					  </div>
					  {/if}
					  {if $app->getStatus(32) == 1}
					  <div class="tab-pane  fade show configlist" id="rounded-pills-icon-32" role="tabpanel" aria-labelledby="rounded-pills-icon-32-tab">
						 <p>
							{$lang->get('setup')}  
							<button  class="btn-dl btn btn-sm btn-relief-primary" style="background-color:{$Config['app_color']};color:white" type="button" style="background-color: {$Config['app_color']};" data-toggle="modal" data-target="#modal_32"><i class="fa-duotone fa-book-open mr-50"></i> {$lang->get('View')} </button>
						 </p>
					  </div>
					  {/if}
				   </div>
