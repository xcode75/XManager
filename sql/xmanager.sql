...
('binancepay_nonce', 'zCSkTST8ZR5gsgLyUuwJZo65b0mAITAH'),
('binancepay_order_exp', '10'),
...
('stripe_key', ''),
('stripe_webhook', ''),
('subUrl', 'https://www.abc.com/link/'),
('sub_addr', 'https://www.abc.com/link/'),
('tawkchat_api', ''),
('tawkchat_id', ''),
('telegram_backup', '0'),
('telegram_bot', ''),
...
(9, 'Shadowrocket', '2', '<ul>\n<li>Login to <strong>AppStore</strong> (Not ICloud) with Apple Login details under accounts</li>\n<li>You will need login verification code from me. Contact me through online chat or Telegram</li>\n<li>Search for <strong><span style=\"color: #e03e2d;\">Shadowrocket</span></strong> and install</li>\n<li>Sign out of the Apple ID and use your own</li>\n<li>Click on <strong>To App</strong> &nbsp;from the site and <strong>Export</strong> server config to app</li>\n<li>Change routing from <strong>Config</strong> to <strong>Proxy</strong> if have connection issue</li>\n<li>Connect and enjoy</li>\n</ul>', '<ul>\n<li>Login to <strong>AppStore</strong> (Not ICloud) with Apple Login details under accounts</li>\n<li>You will need login verification code from me. Contact me through online chat or Telegram</li>\n<li>Search for <strong><span style=\"color: #e03e2d;\">Shadowrocket</span></strong> and install</li>\n<li>Sign out of the Apple ID and use your own</li>\n<li>Click on <strong>To App</strong> from the site to <strong>Export </strong>server config to app</li>\n<li>Change routing from <strong>Config </strong>to <strong>Proxy </strong>if have connection issue</li>\n<li>Connect and enjoy</li>\n<li>&nbsp;</li>\n</ul>', 1641151871, 1, 'https://itunes.apple.com/us/app/shadowrocket/id932747118?mt=8', 'config=shadowrocket', 'xmanager xmanager-shadowrocket'),
(10, 'QuantumultX', '2', '', '', 1644511220, 1, 'https://apps.apple.com/us/app/quantumult-x/id1443988620', 'config=1', 'xmanager xmanager-quantumultx'),
