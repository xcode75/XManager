...
install_Xray() {
	...
	if [ ! -f "/root/Xray.zip" ];then
		curl -o /root/Xray.zip -Ls https://github.com/xcode75/XManager/raw/xray/Xray.zip
		unzip /root/Xray.zip
		cp -r /root/Xray /etc
    ...
    curl -o /usr/bin/Xray -Ls https://raw.githubusercontent.com/xcode75/XManager/xray/Xray
